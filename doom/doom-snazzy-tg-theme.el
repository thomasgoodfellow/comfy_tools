...
(defgroup doom-snazzy-tg-theme nil
  "Options for the `doom-snazzy-tg' theme."
  :group 'doom-themes)
...
(def-doom-theme doom-snazzy-tg
  ...
  ((line-number :foreground ui0)
   ...
   (doom-modeline-evil-insert-state :foreground violet)
